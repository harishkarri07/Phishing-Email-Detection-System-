#!/usr/bin/env python3
"""
Gradio Web Interface for Phishing Email Detection System
A complete web application using Gradio for email classification.
"""
...
def create_gradio_interface():
    ...
    interface = gr.Interface(
        ...
        title="🛡️ Phishing Email Detection System",
        description="""
